...
from repository.PickleRepository import PickleGradeRepository
class TestFileGradeRepository(unittest.TestCase):


    def setUp(self):
        self._grade = Grade("1", "2", [5])
        self._repo = PickleGradeRepository("grades.pickle")
