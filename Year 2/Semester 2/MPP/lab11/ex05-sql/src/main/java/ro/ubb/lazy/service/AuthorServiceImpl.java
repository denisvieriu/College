...
//        List<Author> all = authorRepository.findAllWithBooksAndPublisherJPQL();

//        List<Author> all = authorRepository.findAllWithBooksAndPublisherCriteriaAPI();

        List<Author> all = authorRepository.findAllWithBooksAndPublisherSQL();
